...
export default function App({ path }: { path?: string }) {
  ...
  return <>
    ...
    <section id="hero" className="hero-section"><div className="hero-bg" aria-hidden="true"><span className="hero-grid" /><span className="hero-orb orb-1" /><span className="hero-orb orb-2" /></div><div className="container hero-inner">
      <div className="hero-copy reveal"><span className="hero-chip"><span className="live" aria-hidden="true" />{t('home.brand.en')}</span><h1 className="hero-title"><HtmlText value={t('home.hero.title')} /></h1><p className="hero-desc">{t('home.hero.desc')}</p><div className="hero-cta-row"><a className="btn-primary" href="/apps/">浏览应用中心</a><a className="btn-ghost" href="#contact" onClick={handleAnchorClick}>{t('home.hero.cta.contact')}</a></div><div className="hero-meta">{[0, 1, 2].map((item) => <div className="meta-item" key={item}><span className="meta-num">{t(`home.hero.meta.${item}.num`)}</span><span className="meta-label">{t(`home.hero.meta.${item}.label`)}</span></div>)}</div></div>
    ...
    <section id="about" className="section about-section"><div className="container about-inner"><div className="about-copy reveal"><span className="chapter"><b>CH 01</b> {t('home.nav.about')}</span><h2 className="section-title">{t('home.about.title')}</h2><p className="section-desc">{t('home.about.desc.0')}</p><p className="section-desc">{t('home.about.desc.1')}</p><div className="about-highlights">{[0, 1, 2].map((item) => <div className="hl-box" key={item}><div className="hl-num">{t(`home.about.hl.${item}.num`)}</div><div className="hl-text">{t(`home.about.hl.${item}.text`)}</div></div>)}</div></div><div className="about-card reveal"><div className="about-glass"><p className="about-mini-title">{t('home.about.card.title')}</p><ul className="about-list">{[0, 1, 2, 3].map((item) => <li key={item}>{t(`home.about.card.list.${item}`)}</li>)}</ul><p className="about-mini-note">{t('home.about.card.note')}</p></div></div></div></section>

    <section id="contact" className="section contact-section"><div className="container contact-inner"><div className="contact-left reveal" style={{ maxWidth: 720 }}><span className="chapter"><b>CH 02</b> {t('home.nav.contact')}</span><h2 className="section-title">{t('home.contact.title')}</h2><div className="contact-card"><div className="contact-row"><div className="contact-label">{t('home.contact.label.company')}</div><div className="contact-value">{t('home.common.company')}</div></div><div className="contact-row"><div className="contact-label">{t('home.contact.label.email')}</div><div className="contact-value"><a className="linkish" href={t('home.common.email_mailto')}>{t('home.common.email')}</a></div></div><div className="contact-row"><div className="contact-label">{t('home.contact.label.city')}</div><div className="contact-value">{t('home.common.city')}</div></div></div><p className="contact-hint">{t('home.contact.hint')}</p></div></div></section>
